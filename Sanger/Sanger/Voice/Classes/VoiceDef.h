...
#define DIR_DATABASE                    @"Data"
#define DATABASE_NAME                   @"database1_0.sqlite"
...
#define STRING_ABOUT_US_TILTE           @"《求职面试英语宝典》"
#define STRING_ABOUT_DETAIL             @" 《求职英语面试宝典》的特点有:1)实用性。摒弃贪大求全的理念,重点突出,提供一些实例和范文,便于求职者参考和模仿。按照本APP建议,求职者可学以致用,不断获得成功;2)新颖性。本书提供了大量的信息,贯穿整个求职程序。这些信息贴近生活,读者使用起来倍感亲切,容易产生事半功倍的效用;3)趣味性。本书除了在语言的叙述上力求轻快,使读者心情愉快外,还在可以跟读,找出自己的不足,不断改进。"
